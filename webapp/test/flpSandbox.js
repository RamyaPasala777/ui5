		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "employee_application",
									"targetURL": "#comappempdetailsapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappempdetailsapp-display": {
								"semanticObject": "comappempdetailsapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.empdetailsapp",
									"url": sap.ui.require.toUrl("com/app/empdetailsapp")
								}
							}
						}
					}
